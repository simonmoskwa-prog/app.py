...
def get_data(ticker):
    ...
    # Download mit explizitem Start- und Enddatum
...
# Datumsbereich für X-Achse festlegen (2 Jahre zurück bis +30 Tage Puffer)
today_dt = pd.Timestamp.now()
x_max = today_dt + pd.Timedelta(days=30)
x_min = today_dt - pd.Timedelta(days=730)
