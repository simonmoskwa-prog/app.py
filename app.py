...
st.set_page_config(page_title="Weinstein Stage-Analysis Dashboard | Pulse Trading", layout="wide")

# Header mit dezentem Logo & Titel
            ...
            with st.expander("🔍 Top-Aktien im Stage-2-Setup anzeigen"):
                ...
                if stock_data:
                    ...
                    if selected_ticker:
                        ...
                        fig_stock.update_xaxes(title_text="Datum (Wochen)", row=2, col=1, autorange=True, tickformat="%b %Y")
