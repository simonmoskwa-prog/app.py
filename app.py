...
if not df.empty and 'Close' in df.columns:
    ...
    # Letzte Werte als einzelne Skalarwerte sicherstellen
    ...
    # Layout & automatische Zentrierung der Y-Achse
    fig.update_layout(
    ...
    # Hier wird die Y-Achse automatisch um die echten Min/Max-Kurse zentriert
    fig.update_yaxes(
        title_text="Preis (USD)",
        include_zero=False,  # Verhindert, dass die Skala bei 0 beginnt
        showgrid=True,
        gridcolor='#222831'
    )
