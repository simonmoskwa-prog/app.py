...
def show_glossary_dialog():
    ...
    * **Formel:** Vergleicht die relative Performance der Aktie zum Index mit ihrem eigenen 52-Wochen-Durchschnitt.
    ...
    st.info(
        ...
        "Ein **Mansfield RS Wert von +30** bedeutet, dass die Aktie oder der Sektor aktuell **ca. 30 % stärker performt** "
    ...
    st.markdown("### 📈 2. Stage Analysis (Phasen-Analyse nach Stan Weinstein)")
    st.write("Der Markt bewegt sich nach Stan Weinstein zyklisch in vier Marktphasen:")
    st.markdown("""
    1. **Stage 1 (Bodenbildung / Konsolidierung):** Der Kurs bewegt sich seitwärts um den flachen 30-Wochen-SMA. Institutionen akkumulieren leise.
    2. **Stage 2 (Aufwärtstrend / Momentum):** **Der beste Zeitpunkt zum Kaufen!** Der Kurs bricht über den 30W-SMA aus, der GD steigt deutlich an (> +0.5%).
    3. **Stage 3 (Topbildung / Distribution):** Der Kurs verliert an Schwung, schwankt stark um den abflachenden 30W-SMA. Institutionen verkaufen.
    4. **Stage 4 (Abwärtstrend):** Der Kurs fällt unter den fallenden 30W-SMA (< -0.5%). Klares Ausstiegssignal!
    """)
...
with st.sidebar:
    ...
    if st.session_state["role"] == "admin":
        ...
        with st.expander("👥 Benutzer-Verwaltung", expanded=False):
            ...
            # 2. PASSWORT / ROLLE ÄNDERN (KORRIGIERT MIT DYNAMISCHEN KEYS)
            with tab_edit:
...
st.markdown(
    ...
    <div class="update-banner">
        ...
        <div class="update-banner-text">
            <strong>Kontinuierliche Entwicklung:</strong> Dieses Dashboard befindet sich in aktiver Weiterentwicklung. 
            Klicke oben auf <b>❓ Hilfeseite</b>, um Begriffe wie <i>Mansfield RS</i> oder <i>Stage Analysis</i> genauer erklärt zu bekommen.
        </div>
    </div>
    """,
    unsafe_allow_html=True
