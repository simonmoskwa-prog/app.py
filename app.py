...
def show_glossary_dialog():
    ...
    * **Formel:** Vergleicht die relative Performance der Aktie zum Index mit ihrem eigenen 52-Wochen-Durchschnitt.
    ...
    2. **Stage 2 (Aufstiegsphase / Momentum):** **Der beste Zeitpunkt zum Kaufen!** Der Kurs bricht über den 30W-SMA aus, der GD steigt deutlich an (> +0.5%) und Mansfield RS ist positiv (> 0).
...
st.markdown(
    ...
    <div class="update-banner">
        ...
        <div class="update-banner-text">
            ...
            <strong>Live-Aktien-Analyse mit Volumen & Phasen Check:</strong> Gib ein beliebiges Ticker-Symbol ein, um Handelsvolumen, Phasen-Auswertung und automatische <strong>TOP KANDIDAT</strong> Erkennung zu aktivieren!
        </div>
    </div>
    """,
    unsafe_allow_html=True
...
def check_stan_weinstein_top_candidate(price, sma30, slope, mansfield_rs, volume=None, vol_avg_10w=None):
    ...
    # Volumen-Bedingung: Nur prüfen, wenn Volumen-Daten vorhanden sind
