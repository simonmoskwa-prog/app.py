...
# ---------------------------------------------------------
# AUTHENTICATION (ROBUSTER DIRECT MATCH)
# ---------------------------------------------------------
TARGET_PASSWORD = "pulse2026"
...
def render_login_screen():
    ...
    with col2:
        ...
        with st.container(border=True):
            ...
            if login_btn:
                # Toleriert Groß-/Kleinschreibung sowie Leerzeichen am Anfang/Ende
                if pwd_input.strip().lower() == TARGET_PASSWORD.lower():
