...
def fetch_stock_data(tickers, benchmark_ticker="^GSPC", period="2y"):
    ...
    for ticker in tickers:
        ...
        # RS = (Aktienkurs / Benchmarkkurs)
        # Mansfield RS = ((RS / 52-Wochen-SMA(RS)) - 1) * 100
        ...
        # Bestimmung der Weinstein Phase (Vereinfachte Logik für Screener)
...
if not df_results.empty:
    ...
    styled_df = df_filtered.style.applymap(highlight_phase, subset=["Weinstein Phase"])\
